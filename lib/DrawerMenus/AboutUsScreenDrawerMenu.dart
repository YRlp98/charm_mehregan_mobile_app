...
class AboutUsScrenDrawerMenu extends StatefulWidget {
  @override
  _AboutUsScrenDrawerMenuState createState() => _AboutUsScrenDrawerMenuState();
}

class _AboutUsScrenDrawerMenuState extends State<AboutUsScrenDrawerMenu> {
    ...
    return new AnimatedPositioned(
      ...
      child: new Material(
          ...
          child: new GestureDetector(
            child: new AboutUsScreen(),
            onTap: () {
              setState(() {
                isCollapsed = !isCollapsed;
              });
              // Navigator.of(context).pushReplacementNamed("/AboutUsScreen");
            },
          )),
    );
  }
