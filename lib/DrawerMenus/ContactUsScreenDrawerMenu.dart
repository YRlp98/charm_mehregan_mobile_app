...
class ContactUsScrenDrawerMenu extends StatefulWidget {
  @override
  _ContactUsScrenDrawerMenuState createState() =>
      _ContactUsScrenDrawerMenuState();
}
    ...
    return new AnimatedPositioned(
      ...
      child: new Material(
          ...
          child: new GestureDetector(
            child: new ContactUsScreen(),
            onTap: () {
              setState(() {
                isCollapsed = !isCollapsed;
              });
              // Navigator.of(context).pushReplacementNamed("/ContactUsScreen");
            },
          )),
    );
  }
